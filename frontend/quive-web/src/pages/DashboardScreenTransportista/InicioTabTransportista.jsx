...
const InicioTabTransportista = ({ userData}) => {
  return(
    <>
    {/* Welcome Card */}
    <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 text-white mb-8">
      <h2 className="text-2xl font-bold mb-2">¡Hola TRANSPORTISTA, {userData.name || 'Usuario'}!</h2>
      <p className="text-blue-100 mb-4">
      ¿Listo para ayudar con mudanzas? Revisa los pedidos disponibles.
      </p>
...
export default InicioTabTransportista;